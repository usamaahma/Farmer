        ...
        <nav className={`navbar ${scrolled ? 'scrolled' : ''}`}>
            ...
            <div className={`navbar-content ${isOpen ? 'active' : ''}`}>
                <ul className="navbar-links">
                    ...
                    <li><a href="/crops" onClick={handleLinkClick}>Crops</a></li>
                    <li><a href="/weather" onClick={handleLinkClick}>Weather</a></li>
                    <li><a href="/market" onClick={handleLinkClick}>Market</a></li>
